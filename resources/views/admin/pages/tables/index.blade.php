...
@section('content_header')
    ...
    <h1>Mesas
        <a href="{{route('tables.create')}}" class="btn btn-dark"><i class="far fa-calendar-plus"></i> Adicionar mesa</a>
    </h1>
@stop
                ...
                <tbody>
                    @foreach ($tables as $table)
                        <tr>
                            ...
                            <td style='width=10px;'>
                                <a href="{{route('tables.show', $table->id)}}" class="btn btn-info"><i class="fas fa-angle-double-right"></i> Ver</a>
                                <a href="{{route('tables.edit', $table->id)}}" class="btn btn-warning"><i class="far fa-edit"></i> Editar</a>

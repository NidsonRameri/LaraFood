...
@section('content_header')
    ...
    <h1>Cargos
        <a href="{{route('roles.create')}}" class="btn btn-dark"><i class="far fa-calendar-plus"></i> Adicionar Cargo</a>
    </h1>
@stop
                    ...
                    @foreach ($roles as $role)
                        <tr>
                            ...
                            <td style='width=10px;'>
                                ...
                                <a href="{{route('roles.show', $role->id)}}" class="btn btn-info"><i class="fas fa-angle-double-right"></i> Ver</a>
                                <a href="{{route('roles.edit', $role->id)}}" class="btn btn-warning"><i class="far fa-edit"></i> Editar</a>

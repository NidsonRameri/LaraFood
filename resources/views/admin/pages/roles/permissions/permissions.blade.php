...
@section('content_header')
    ...
    <h1>Permissões do cargo <strong>{{$role->name}}</strong>
        <a href="{{route('roles.permissions.available', $role)}}" class="btn btn-dark"><i class="far fa-calendar-plus"></i> Adicionar nova permissão</a>
    </h1>
@stop
                    ...
                    @foreach ($permissions as $permission)
                        <tr>
                            ...
                            <td style='width=10px;'>
                                ...
                                <a href="{{route('roles.permissions.detach', [$role->id, $permission->id])}}" class="btn btn-danger"><i class="fas fa-angle-double-right"></i> Remover</a>
                            </td>
                        </tr>
                    @endforeach 
                </tbody>
